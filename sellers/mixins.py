...
from cart.mixins import LoginRequiredMixin
...
class SellerAccountMixin(object):
	...
	def get_total_sales(self):
		transactions = self.get_transactions().aggregate(Sum("amount"), Avg("amount"))
		print (transactions)
		total_sales = transactions["amount__sum"]
		return total_sales

	def get_today_sales(self):
		transactions = self.get_transactions_today().aggregate(Sum("amount"))
		total_sales = transactions["amount__sum"]
		return total_sales
